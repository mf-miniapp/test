"""attack-surface-enumeration specialist — loads SOUL_BODY / ATTRIBUTION_BODY for the clone script.
...
Use like:
    from opensquilla.agents.attack-surface-enumeration import SOUL_BODY
"""
