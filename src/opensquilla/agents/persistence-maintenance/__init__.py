"""persistence-maintenance specialist — loads SOUL_BODY / ATTRIBUTION_BODY for the clone script.
...
Use like:
    from opensquilla.agents.persistence-maintenance import SOUL_BODY
"""
