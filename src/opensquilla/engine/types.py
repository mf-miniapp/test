...
class AgentConfig:
    ...
    # truncates to this many tokens (4 chars/token) so a large run does
    # not blow up the next turn's request budget. Default 2000 tokens
    # ≈ 8000 chars. Mirrors the [llm].request_context_prompt_max_tokens
    # TOML field; the bootstrap stage wires the value across.
